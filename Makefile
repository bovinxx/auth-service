...
test-coverage:
	go clean -testcache
	go test ./... -coverprofile=coverage.tmp.out -covermode count -coverpkg=github.com/bovinxx/auth/internal/api/...,github.com/bovinxx/auth/internal/service/user/... -count 5
