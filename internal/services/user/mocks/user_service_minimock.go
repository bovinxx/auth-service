...
//go:generate minimock -i github.com/bovinxx/auth-service/internal/services/user.UserService -o user_service_minimock.go -n UserServiceMock -p mocks
...
func (mmCreateUser *mUserServiceMockCreateUser) Expect(ctx context.Context, user *models.User) *mUserServiceMockCreateUser {
...
func (mmCreateUser *mUserServiceMockCreateUser) ExpectUserParam2(user *models.User) *mUserServiceMockCreateUser {
	if mmCreateUser.mock.funcCreateUser != nil {
		mmCreateUser.mock.t.Fatalf("UserServiceMock.CreateUser mock is already set by Set")
	}
...
func (mmCreateUser *mUserServiceMockCreateUser) Inspect(f func(ctx context.Context, user *models.User)) *mUserServiceMockCreateUser {
...
func (mmCreateUser *mUserServiceMockCreateUser) Set(f func(ctx context.Context, user *models.User) (i1 int64, err error)) *UserServiceMock {
	if mmCreateUser.defaultExpectation != nil {
...
// Then helper
func (mmCreateUser *mUserServiceMockCreateUser) When(ctx context.Context, user *models.User) *UserServiceMockCreateUserExpectation {
	if mmCreateUser.mock.funcCreateUser != nil {
		mmCreateUser.mock.t.Fatalf("UserServiceMock.CreateUser mock is already set by Set")
	}
...
func (mmCreateUser *UserServiceMock) CreateUser(ctx context.Context, user *models.User) (i1 int64, err error) {
...
func (mmGetUser *mUserServiceMockGetUser) Set(f func(ctx context.Context, id int64) (up1 *models.User, err error)) *UserServiceMock {
	if mmGetUser.defaultExpectation != nil {
...
func (mmGetUser *UserServiceMock) GetUser(ctx context.Context, id int64) (up1 *models.User, err error) {
...
func (mmUpdateUser *mUserServiceMockUpdateUser) Expect(ctx context.Context, id int64, name string, oldPassword string, newPassword string) *mUserServiceMockUpdateUser {
	...
	mmUpdateUser.defaultExpectation.params = &UserServiceMockUpdateUserParams{ctx, id, name, oldPassword, newPassword}
...
// ExpectNameParam3 sets up expected param name for UserService.UpdateUser
func (mmUpdateUser *mUserServiceMockUpdateUser) ExpectNameParam3(name string) *mUserServiceMockUpdateUser {
	if mmUpdateUser.mock.funcUpdateUser != nil {
		mmUpdateUser.mock.t.Fatalf("UserServiceMock.UpdateUser mock is already set by Set")
	}
...
// ExpectOldPasswordParam4 sets up expected param oldPassword for UserService.UpdateUser
func (mmUpdateUser *mUserServiceMockUpdateUser) ExpectOldPasswordParam4(oldPassword string) *mUserServiceMockUpdateUser {
	if mmUpdateUser.mock.funcUpdateUser != nil {
		mmUpdateUser.mock.t.Fatalf("UserServiceMock.UpdateUser mock is already set by Set")
	}
...
// ExpectNewPasswordParam5 sets up expected param newPassword for UserService.UpdateUser
func (mmUpdateUser *mUserServiceMockUpdateUser) ExpectNewPasswordParam5(newPassword string) *mUserServiceMockUpdateUser {
	if mmUpdateUser.mock.funcUpdateUser != nil {
		mmUpdateUser.mock.t.Fatalf("UserServiceMock.UpdateUser mock is already set by Set")
	}
...
func (mmUpdateUser *mUserServiceMockUpdateUser) Inspect(f func(ctx context.Context, id int64, name string, oldPassword string, newPassword string)) *mUserServiceMockUpdateUser {
...
func (mmUpdateUser *mUserServiceMockUpdateUser) Set(f func(ctx context.Context, id int64, name string, oldPassword string, newPassword string) (err error)) *UserServiceMock {
	if mmUpdateUser.defaultExpectation != nil {
...
// Then helper
func (mmUpdateUser *mUserServiceMockUpdateUser) When(ctx context.Context, id int64, name string, oldPassword string, newPassword string) *UserServiceMockUpdateUserExpectation {
	if mmUpdateUser.mock.funcUpdateUser != nil {
		mmUpdateUser.mock.t.Fatalf("UserServiceMock.UpdateUser mock is already set by Set")
	}
	...
	expectation := &UserServiceMockUpdateUserExpectation{
		...
		params:             &UserServiceMockUpdateUserParams{ctx, id, name, oldPassword, newPassword},
...
func (mmUpdateUser *UserServiceMock) UpdateUser(ctx context.Context, id int64, name string, oldPassword string, newPassword string) (err error) {
	...
	mm_params := UserServiceMockUpdateUserParams{ctx, id, name, oldPassword, newPassword}
	...
	if mmUpdateUser.UpdateUserMock.defaultExpectation != nil {
		...
		mm_got := UserServiceMockUpdateUserParams{ctx, id, name, oldPassword, newPassword}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.id != nil && !minimock.Equal(*mm_want_ptrs.id, mm_got.id) {
				mmUpdateUser.t.Errorf("UserServiceMock.UpdateUser got unexpected parameter id, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
			...
			if mm_want_ptrs.name != nil && !minimock.Equal(*mm_want_ptrs.name, mm_got.name) {
				mmUpdateUser.t.Errorf("UserServiceMock.UpdateUser got unexpected parameter name, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
			...
			if mm_want_ptrs.oldPassword != nil && !minimock.Equal(*mm_want_ptrs.oldPassword, mm_got.oldPassword) {
				mmUpdateUser.t.Errorf("UserServiceMock.UpdateUser got unexpected parameter oldPassword, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
			...
			if mm_want_ptrs.newPassword != nil && !minimock.Equal(*mm_want_ptrs.newPassword, mm_got.newPassword) {
				mmUpdateUser.t.Errorf("UserServiceMock.UpdateUser got unexpected parameter newPassword, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
	...
	mmUpdateUser.t.Fatalf("Unexpected call to UserServiceMock.UpdateUser. %v %v %v %v %v", ctx, id, name, oldPassword, newPassword)
	return
}
