...
func (m *CreateRequest) validate(all bool) error {
	...
	if l := utf8.RuneCountInString(m.GetPassword()); l < 5 || l > 64 {
		err := CreateRequestValidationError{
			field:  "Password",
...
func (m *UpdateRequest) validate(all bool) error {
	...
	if l := utf8.RuneCountInString(m.GetOldPassword()); l < 5 || l > 64 {
		err := UpdateRequestValidationError{
			field:  "OldPassword",
			reason: "value length must be between 5 and 64 runes, inclusive",
		}
	...
	if l := utf8.RuneCountInString(m.GetNewPassword()); l < 5 || l > 64 {
		err := UpdateRequestValidationError{
			field:  "NewPassword",
			reason: "value length must be between 5 and 64 runes, inclusive",
		}
